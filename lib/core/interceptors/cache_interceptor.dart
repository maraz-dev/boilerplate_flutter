...
import 'package:boilerplate_flutter/core/storage/cache/cache_response.dart';
import 'package:boilerplate_flutter/core/storage/cache/config.dart';
...
class CacheInterceptor implements Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) async {
    if (kDebugMode) {
      ...
      debugPrint("--> END ${options.method != "" ? options.method.toUpperCase() : 'METHOD'}");
    }
