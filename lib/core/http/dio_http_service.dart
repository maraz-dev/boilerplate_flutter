...
import 'package:boilerplate_flutter/core/connection/connection.dart';
import 'package:boilerplate_flutter/core/error/error_handler.dart';
import 'package:boilerplate_flutter/core/http/http_service.dart';
import 'package:boilerplate_flutter/core/interceptors/token_interceptor.dart';
...
class NetworkService implements HttpService {
  ...
  NetworkService._({
    ...
    _cacheStore = cacheStoreOverride ?? MemCacheStore(maxSize: 10485760, maxEntrySize: 1048576);
      ...
      switch (method) {
        case RequestMethod.post:
          ...
          response = await _dio.post(path,
              queryParameters: queryParams, data: data, cancelToken: cancelToken, options: options);
          break;
